...
** modifier on the d flag
** length_modifier_on_d
*/

#include "my.h"
#include "my_printf.h"

int other_length_modifier_aux_d(char *atribute_char,
...
int other_length_modifier_d(char *atribute_char,
    char *length_modifier, va_list args, int *count)
{
    ...
    return other_length_modifier_aux_d(atribute_char,
    length_modifier, args, count);
}

int l_length_modifier_d(char *atribute_char,
    char *length_modifier, va_list args, int *count)
{
    ...
    return other_length_modifier_d(atribute_char,
    length_modifier, args, count);
}

int h_length_modifier_d(char *atribute_char,
    char *length_modifier, va_list args, int *count)
{
    ...
    return l_length_modifier_d(atribute_char, length_modifier, args, count);
}
    ...
    va_list args, int *count)
{
    ...
    ans = h_length_modifier_d(atribute_char, length_modifier, args, count);
    if (ans == -1)
        return -1;
    return 0;
}
